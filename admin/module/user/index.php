		...
		<div class="card card-dark">
			...
			<div class="card-footer">
				<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
					...
					<br><br>	
					<button type="submit" class="btn btn-dark btn-md" value="Tambah">
				...
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit"
						...
						<fieldset>
							...
							<div class="control-group mb-3">
								<label class="control-label" for="typeahead">Posisi </label>
								<div class="input-group">
									<input type="text" class="form-control" style="border-radius:0px;" name="posisi"
										value="<?php echo $hasil['posisi']; ?>" required="required" />
								</div>
							</div>
							<div class="control-group mb-3">
							...
							<input type="hidden" name="id" value="<?php echo $hasil['id_member']; ?>">
							<button class="btn btn-dark" name="btn" value="Tambah">
				...
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
						<fieldset>
							...
							<button type="submit" class="btn btn-dark" value="Tambah" name="proses"><i class="fas fa-edit"></i> Ubah Password</button>
						</fieldset>
					</form>
				</div>
			</div>
